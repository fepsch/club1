<div id="contenedor-portada">
    ...
    <div id="conteo-home" class="bg-rojo">
        <div id="nrochefs" class="cuadro-conteo">
            ...
            <span class="contados">Chefs</span>
        </div>
        <div id="nroplatos" class="cuadro-conteo">
            ...
            <span class="contados">Experiencias</span>
        </div>
    </div>
</div>
<div class="buscador">
    ...
    <div class="container-fields">
        ...
        <select name="comuna">
            ...
            <?php foreach ($comunas as $comuna): ?>
                <option value="<?= $comuna['idMeta'] ?>"><?= $comuna['nombreMeta']; ?></option>
            <?php endforeach; ?>
        </select>
        ...
        <select name="tag">
            ...
            <?php foreach ($tags as $tag): ?>
                <option value="<?= $tag['idMeta'] ?>"><?= $tag['nombreMeta']; ?></option>
            <?php endforeach; ?>
        </select>
        <!-- <input type="text" placeholder="Tags" name="tag" class="tag-buscador"> -->
        <input type="text" placeholder="Nombre del chef" class="nombrechef-buscador input_autocomplete" name="nombre_chef">
                        ...
                        <div class="carruselhome-chef">
                            <div class="ca-avatar-home">
                                ...
                                if ($chef['avatar'] == '')
                                    ...
                                    $imgChef = $chef['avatar'];
                                ?>
                                <a href="<?= base_url('chefs/verDatosChef/' . $chef['idUsuario']); ?>"><img src="<?= base_url('avatar/' . $imgChef); ?>" alt="avatar chef" /></a>
                            </div>
                            <div class="ca-nombre-home bg-rojo"><a href="<?= base_url('chefs/verDatosChef/' . $chef['idUsuario']); ?>"><?= $chef['nombre']; ?></a></div>
                            <div class="ca-descripcion-home overflowauto"><?= isset($chef['dato']) ? $chef['dato'] : 'No existe descripción' ?></div>
                            <div class="link-preparaciones float-right">
                                <a href="<?= base_url('chefs/verDatosChef/' . $chef['idUsuario']); ?>">Conocer las experiencias</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
